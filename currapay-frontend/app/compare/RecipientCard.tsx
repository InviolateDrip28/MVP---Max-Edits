...
export default function RecipientCard(props: RecipientCardProps) {
  ...
  return (
    ...
    >
      ...
      <p className="mb-2 pr-12 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">
        Recipient recieves
      </p>
      <h1 className="pb-12 pr-12 mb-2 font-semibold tracking-tight text-gray-900 dark:text-white">
